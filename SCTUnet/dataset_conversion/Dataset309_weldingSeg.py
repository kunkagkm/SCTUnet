...
if __name__ == "__main__":
    ...
    source = 'F:/pytorch_study/Segmentation/nnUNet-master/nnUNet-master/Dataset/nnUNet_raw/nnUNet_raw_data/Dataset309_weldingseg'

    # dataset_name = 'Dataset120_RoadSegmentation'
    dataset_name = 'Dataset309_weldingseg'
